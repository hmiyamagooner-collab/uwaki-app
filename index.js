{
  "name": "uwaki-app",
  "version": "1.0.0",
  "description": "STEALTH FILE - LINE relationship psychology check bot",
  "main": "index.js",
  "scripts": {
    "start": "node index.js"
  },
    ...
    contents: {
      ...
      body: {
        ...
        contents: [
          ...
          { type: 'text', text: 'その違和感、気のせいですか？\n15の質問で関係性をそっとチェック。', wrap: true, size: 'sm', color: COLOR.subOnLight, align: 'center', margin: 'md' },
          {
            type: 'box',
            layout: 'vertical',
            margin: 'xl',
            contents: [
              { type: 'button', style: 'primary', color: COLOR.brown, height: 'md', action: { type: 'message', label: '診断をはじめる', text: '診断開始' } }
            ]
          },
      ...
      body: {
        ...
        contents: [
          brandHeader(`Q${questionNumber} / ${total}`),
          {
            ...
            margin: 'md',
            contents: [
              { type: 'box', layout: 'vertical', width: `${Math.max(ratio, 3)}%`, height: '5px', backgroundColor: COLOR.gold, cornerRadius: '99px', contents: [] }
            ]
          },
        ...
        contents: [
          ...
          { type: 'text', text: 'あなたの状況に合わせて、\n次の一歩をそっとご案内します。', wrap: true, size: 'sm', color: COLOR.subOnLight, align: 'center', margin: 'md' },
          {
            ...
            contents: [
              ...
              { type: 'button', style: 'secondary', height: 'md', action: { type: 'message', label: 'もう一度診断する', text: '診断開始' } }
            ]
          },
...
function buildResult(current) {
  ...
  const counselorPatterns = {
    ...
    印象の変化: [
      ...
      '印象の変化そのものより、その理由が見えるかどうかが大切なポイントです。'
    ],
    気持ちの揺れ: [
      '急な優しさや冷たさの落差には、心の揺れが表れていることがあります。',
      'あなたが「前と違う」と感じているなら、その感覚は大切にしてあげてください。'
    ]
  };
      ...
      body: {
        ...
        contents: [
          ...
          { type: 'text', text: `${score}%`, size: '3xl', weight: 'bold', color: COLOR.greige, align: 'center' },
          {
            ...
            margin: 'lg',
            contents: [
              { type: 'box', layout: 'vertical', width: `${Math.max(score, 2)}%`, height: '8px', backgroundColor: COLOR.gold, cornerRadius: '99px', contents: [] }
            ]
          },
          ...
          },
          {
            ...
            contents: [
              ...
              { type: 'box', layout: 'horizontal', margin: 'sm', contents: [ { type: 'text', text: '距離感', size: 'sm', color: COLOR.textOnDark, flex: 4 }, { type: 'text', text: bar(radar['距離感']), size: 'sm', color: COLOR.gold, align: 'end', flex: 5 } ] },
              { type: 'box', layout: 'horizontal', margin: 'sm', contents: [ { type: 'text', text: '連絡の変化', size: 'sm', color: COLOR.textOnDark, flex: 4 }, { type: 'text', text: bar(radar['連絡の変化']), size: 'sm', color: COLOR.gold, align: 'end', flex: 5 } ] },
              { type: 'box', layout: 'horizontal', margin: 'sm', contents: [ { type: 'text', text: '生活リズム', size: 'sm', color: COLOR.textOnDark, flex: 4 }, { type: 'text', text: bar(radar['生活リズム']), size: 'sm', color: COLOR.gold, align: 'end', flex: 5 } ] },
              { type: 'box', layout: 'horizontal', margin: 'sm', contents: [ { type: 'text', text: '印象の変化', size: 'sm', color: COLOR.textOnDark, flex: 4 }, { type: 'text', text: bar(radar['印象の変化']), size: 'sm', color: COLOR.gold, align: 'end', flex: 5 } ] },
              { type: 'box', layout: 'horizontal', margin: 'sm', contents: [ { type: 'text', text: '気持ちの揺れ', size: 'sm', color: COLOR.textOnDark, flex: 4 }, { type: 'text', text: bar(radar['気持ちの揺れ']), size: 'sm', color: COLOR.gold, align: 'end', flex: 5 } ] }
            ]
          },
          {
            type: 'box',
