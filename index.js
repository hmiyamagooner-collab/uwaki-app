...
function createTopMessage(){return {type:'flex',altText:'パートナー心理分析をはじめる',contents:{type:'bubble',hero:{type:'image',url:TOP_IMAGE_URL,size:'full',aspectRatio:'1536:1024',aspectMode:'fit',backgroundColor:'#1E1E1E',action:{type:'message',label:'分析をはじめる',text:'分析スタート'}},styles:{body:{backgroundColor:COLOR.greige}},body:{type:'box',layout:'vertical',spacing:'md',paddingAll:'20px',contents:[{type:'text',text:'パートナー心理分析',size:'lg',weight:'bold',color:COLOR.textOnLight,align:'center'},{type:'text',text:'その違和感、気のせいですか？\n15の質問で関係性をそっとチェック。',wrap:true,size:'sm',color:COLOR.subOnLight,align:'center',margin:'sm'},{type:'box',layout:'vertical',margin:'lg',contents:[{type:'button',style:'primary',color:COLOR.brown,height:'md',action:{type:'message',label:'診断をはじめる',text:'分析スタート'}}]},{type:'text',text:'匿名OK・記録は残りません',size:'xs',color:COLOR.hintOnLight,align:'center',margin:'md'}]}}};}
