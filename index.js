...
const TOP_IMAGE_URL = 'https://uwaki-app.onrender.com/top3.png';
...
function createGenderMessage(){return {type:'flex',altText:'お相手の性別を教えてください',contents:{type:'bubble',styles:{body:{backgroundColor:COLOR.paper}},body:{type:'box',layout:'vertical',spacing:'md',paddingAll:'22px',contents:[brandHeader(''),{type:'text',text:'お相手の性別を教えてください',size:'md',weight:'bold',color:COLOR.textOnLight,align:'center',margin:'md'},{type:'text',text:'気になるお相手について、\nより正確に分析するために伺います。',wrap:true,size:'sm',color:COLOR.subOnLight,align:'center',margin:'sm'},{type:'box',layout:'vertical',spacing:'sm',margin:'lg',contents:GENDERS.map(g=>({type:'button',style:'secondary',height:'md',action:{type:'message',label:g,text:g}}))}]}}};}

function createAgeMessage(){return {type:'flex',altText:'お相手の年代を教えてください',contents:{type:'bubble',styles:{body:{backgroundColor:COLOR.paper}},body:{type:'box',layout:'vertical',spacing:'md',paddingAll:'22px',contents:[brandHeader(''),{type:'text',text:'お相手の年代を教えてください',size:'md',weight:'bold',color:COLOR.textOnLight,align:'center',margin:'md'},{type:'text',text:'お相手のおおよその年代を\n選択してください。',wrap:true,size:'sm',color:COLOR.subOnLight,align:'center',margin:'sm'},{type:'box',layout:'vertical',spacing:'sm',margin:'lg',contents:AGES.map(a=>({type:'button',style:'secondary',height:'md',action:{type:'message',label:a,text:a}}))}]}}};}
